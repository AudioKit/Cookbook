...
class PitchShiftOperationConductor: ObservableObject, ProcessesPlayerInput {
    ...
    init() {
        ...
        pitchShiftPlot.plotType = .rolling
        pitchShiftPlot.color = .blue
        pitchShiftPlot.shouldFill = true
        pitchShiftPlot.shouldMirror = true
        pitchShiftPlot.setRollingHistoryLength(128)
